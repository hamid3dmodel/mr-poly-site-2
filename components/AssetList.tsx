...
export default function AssetList({
    ...
    return (
        <div className="w-full">
            ...
            {loading ? (
                <div className="rounded-xl border border-dashed border-white/15 p-10 text-center text-sm text-zinc-500">
                    Loading assets...
                </div>
            ) : filteredAssets.length ===
            0 ? (
                <div className="rounded-xl border border-dashed border-white/15 p-10 text-center text-sm text-zinc-500">
                    No assets match this
                    list.
                </div>
            ) : (
                <div
                    className={`grid ${columnClasses[columns]}`}
                    style={{
                        gap,
                    }}
                >
